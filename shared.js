...
// ==========================================
const NQOS_VERSION = 'v1.0.2-dev (4be7731)'; // AUTO-GENERATED BY GIT HOOK
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    appendVersionToFooter();
});

function appendVersionToFooter() {
    const footerCopy = document.querySelector('.footer-copy');
    if (footerCopy) {
        // Append the version, e.g., "© 2026 NQoS Tools. - Version: v1.0.x-dev"
        footerCopy.innerHTML += ` &nbsp;|&nbsp; <span style="color: #95a5a6; font-size: 0.9em;">Version: ${NQOS_VERSION} (Under Development)</span>`;
    }
}
