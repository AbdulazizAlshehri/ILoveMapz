const KEYS = {
    USER: 'nqos_visitor_id',
    SESSION: 'nqos_session_current',
    LOG: 'nqos_activity_master_log' // Single source of truth
};
        ...
        if (fileInfo) {
            ...
            fileInfo.innerHTML = `
                <div style="display:flex; align-items:center; width:100%;">
                    ...
                    <i class="fa-solid fa-xmark btn-remove-file" title="Remove file" style="cursor:pointer; color:#e74c3c; padding:4px; border-radius:50%; transition:background 0.2s;"></i>
                </div>
            `;
